...
reproducibility_page = st.Page("apps/reproducibility.py", title="Reproducibility (V-measure)", icon="🔁")
interrater_agreement_page = st.Page("apps/interrater_agreement.py", title="Inter-rater Agreement (Cohen's Kappa)", icon="🤝")
known_vs_unknown_page = st.Page("apps/known_vs_unknown.py", title="Known vs Unknown (Concordance)", icon="🧬")
