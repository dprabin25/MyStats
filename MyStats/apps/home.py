...
with st.container(border=True):
    ...
    st.markdown(
        ...
        "(PMID and UniProt accessions are preloaded -- add more, such as Immunoxpresso, once "
        "you know their format) and builds a Citation ID × narrative agreement table "
        "(no duplicates), with CSV export."
    )
